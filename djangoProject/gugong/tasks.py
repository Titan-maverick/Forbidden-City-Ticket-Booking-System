    ...
    for order in unpaid_orders:
        ...
        try:
            ...
            for audience in audience_list:
                ...
                daily_sales[0], created = DailyTicketSale.objects.get_or_create(
                ...
                if isTreasureIslandSelected:
                    ...
                    daily_sales[1], created = DailyTicketSale.objects.get_or_create(
                        ticket_type=ticket_type_ticket_id,
                        date=formatted_date,
                        select_time=selected_time,
                    )
                if isClockMuseumSelected:
                    ...
                    daily_sales[2], created = DailyTicketSale.objects.get_or_create(
                        ticket_type=ticket_type_ticket_id,
                        date=formatted_date,
                        select_time=selected_time,
                    )
                if isExhibitionSelected:
                    ...
                    daily_sales[3], created = DailyTicketSale.objects.get_or_create(
                        ticket_type=ticket_type_ticket_id,
                        date=formatted_date,
                        select_time=selected_time,
                    )
            ...
            for audience in audience_list:
                ...
                if tickets_available:
                    ...
                    daily_sales[0].ticket_count -= 1
                    ticket_type = TicketType.objects.get(ticket_type_id=ticket_id)
                    daily_sales[0].type_name = ticket_type.type_name
                    daily_sales[0].total_amount = Decimal(daily_sales[0].total_amount) - Decimal(
                        ticket_type.price)
                ...
                if isTreasureIslandSelected:
                    ...
                    daily_sales[1].ticket_count -= 1
                    ticket_type = TicketType.objects.get(ticket_type_id=(ticket_id + 4))
                    daily_sales[1].type_name = ticket_type.type_name
                    daily_sales[1].total_amount = Decimal(daily_sales[1].total_amount) - Decimal(
                        ticket_type.price)
                ...
                if isClockMuseumSelected:
                    ...
                    daily_sales[2].ticket_count -= 1
                    ticket_type = TicketType.objects.get(ticket_type_id=(ticket_id + 8))
                    daily_sales[2].type_name = ticket_type.type_name
                    daily_sales[2].total_amount = Decimal(daily_sales[2].total_amount) - Decimal(
                        ticket_type.price)
                ...
                if isExhibitionSelected:
                    ...
                    daily_sales[3].ticket_count -= 1
                    ticket_type = TicketType.objects.get(ticket_type_id=13)
                    daily_sales[3].type_name = ticket_type.type_name
                    daily_sales[3].total_amount = Decimal(daily_sales[3].total_amount) - Decimal(
                        ticket_type.price)
